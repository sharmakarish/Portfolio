...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.error("OOps, something went wrong !! Please try again.",     {className: "toast-error"});
          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
              <p>Dive into the digital realm with me—let's connect our creative wavelengths! 🌐✨ </p>
